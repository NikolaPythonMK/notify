  ...
  return (
    <div className='page-wrapper'>
      <div className='page-container'>
        ...
        <div className='col-1'>
          <span className='circle'></span><p className='page-title' spellCheck="false"  onDoubleClick={(e) => handleOnDoubleClick(e)}>Lorem ipsum dolor sit amet.</p>
        </div>
        <div className='col-2'>
          <p className='page-content' spellCheck="false"  onDoubleClick={(e) => handleOnDoubleClick(e)}
                                                        >
